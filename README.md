...
- <img src="/bash-original.svg" height="18px" width="18px" /> writing shell scripts;
- ⚽ practicing sports every now and then;
- 💻 ricing my computer;
- 🎸 playing music;
- <img src="/linux-original.svg" height="18px" width="18px" /> learning more about Linux/Unix.
